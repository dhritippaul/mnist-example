...
print("=============================================================================================================================================")
print("Gamma has no role to play in DecisiontreeClassifier, we observe that in validation set , the performance of Decisiontree is better than SVM.")
print("=============================================================================================================================================")
...
print("\t\tResize \t\tDataset \t\tgamma_value \t\tAccuracy@SVM \t\tAccuracy@DecisionTreeClassifier")
#os.mkdir('models')
for i in range(len(resize_images_size)):
    ...
    print("\t\t ",resize_images_size[i] ,"\t\tValidation Set","\t\t",max_valid_acc_model_candidate["gamma"],"\t\t",acc_val*100,"\t\t",acc_val2*100)
    print("\t\t ",resize_images_size[i] ,"\t\tTest Set","\t\t",max_valid_acc_model_candidate["gamma"],"\t\t",acc_test*100,"\t\t",acc_test2*100)
